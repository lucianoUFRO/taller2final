...
int id ; //Para identificar el producto a editar
    ...
    private void botonIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonIngresarActionPerformed
        String[] fila = new String[4];
            ...
            TablaInventario.setModel(modelo);
            LimpiarTexto();
            // Agregamos objeto para que usuario ingrese datos a la tabla de la bd:
        // metodo para ingresar los datos a la base de datos por medio de un boton pero no nos da
        //inventaryDAO producto = new inventaryDAO();
        //if (producto.insertarDatos(codigoP.getText(), nombreP.getText(), precioP.getText(), descripcionP.getText())) {
